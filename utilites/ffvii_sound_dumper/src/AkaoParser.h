...
class AkaoParser: public Ogre::Singleton< AkaoParser >
{
public:
    AkaoParser();
    virtual ~AkaoParser();
...
private:
    ...
    ChannelConfig m_MusicChannelConfig; // 8009a104
...
private:
    ...
    void UpdateSpuReverbDepth( u8 flag, u16 arg_left, u16 arg_right );
