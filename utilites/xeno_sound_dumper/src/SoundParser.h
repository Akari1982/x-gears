...
private:
    ...
    struct MainData
    {
        ...
        s32 update_real_speed;              // 0x54
        s32 update_base_speed;              // 0x58
        s32 update_base_speed_incr_add;     // 0x5c
        u16 update_base_speed_incr_steps;   // 0x60
        s16 update_base_speed_incr_final;   // 0x62
        s32 update_real_speed_mod;          // 0x64
        u16 unk6c;                          // 0x6c
