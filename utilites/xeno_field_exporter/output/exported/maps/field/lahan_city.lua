...
Entity[ "1" ] = {
    on_start = function( self )
        self.entity:init_pc( 0 ) -- 0x009a 0x16
...
Entity[ "2" ] = {
    on_start = function( self )
        self.entity:init_pc( 2 ) -- 0x0118 0x16
...
Entity[ "3" ] = {
    on_start = function( self )
        self.entity:init_pc( 1 ) -- 0x0123 0x16
...
Entity[ "4" ] = {
    on_start = function( self )
        self.entity:init_pc( 3 ) -- 0x012e 0x16
        -- 0xFE0D_SetAvatar( character_id=3 ); -- 0x0131 0xfe
...
Entity[ "5" ] = {
    on_start = function( self )
        self.entity:init_pc( 5 ) -- 0x0139 0x16
        -- 0xFE0D_SetAvatar( character_id=5 ); -- 0x013c 0xfe
...
Entity[ "6" ] = {
    on_start = function( self )
        self.entity:init_pc( 4 ) -- 0x0144 0x16
        -- 0xFE0D_SetAvatar( character_id=4 ); -- 0x0147 0xfe
...
Entity[ "7" ] = {
    on_start = function( self )
        self.entity:init_pc( 6 ) -- 0x014f 0x16
        -- 0xFE0D_SetAvatar( character_id=6 ); -- 0x0152 0xfe
...
Entity[ "8" ] = {
    on_start = function( self )
        self.entity:init_pc( 7 ) -- 0x015a 0x16
        -- 0xFE0D_SetAvatar( character_id=7 ); -- 0x015d 0xfe
...
Entity[ "9" ] = {
    on_start = function( self )
        self.entity:init_pc( 8 ) -- 0x0165 0x16
        -- 0xFE0D_SetAvatar( character_id=8 ); -- 0x0168 0xfe
...
Entity[ "10" ] = {
    on_start = function( self )
        self.entity:init_npc( 0 ) -- 0x0170 0x0b
        -- MISSING OPCODE 0x20
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x017f 0x26
...
Entity[ "11" ] = {
    on_start = function( self )
        self.entity:init_npc( 1 ) -- 0x01b2 0x0b
        -- MISSING OPCODE 0x23
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x01ba 0x26
...
Entity[ "12" ] = {
    on_start = function( self )
        self.entity:init_npc( 1 ) -- 0x01da 0x0b
        -- MISSING OPCODE 0x20
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x01eb 0x26
...
Entity[ "13" ] = {
    on_start = function( self )
        self.entity:init_npc( 1 ) -- 0x0209 0x0b
        -- MISSING OPCODE 0x1d
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x021d 0x26
...
Entity[ "15" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit(); -- 0x0306 0xbc
...
Entity[ "19" ] = {
    on_start = function( self )
        self.entity:init_npc( 4 ) -- 0x07d3 0x0b
        -- MISSING OPCODE 0x1d
    end,
...
Entity[ "22" ] = {
    on_start = function( self )
        self.entity:init_npc( 4 ) -- 0x09ff 0x0b
        -- MISSING OPCODE 0x20
    end,
...
Entity[ "23" ] = {
    on_start = function( self )
        self.entity:init_npc( 3 ) -- 0x0aca 0x0b
        -- MISSING OPCODE 0x20
    end,
...
Entity[ "25" ] = {
    on_start = function( self )
        self.entity:init_npc( 9 ) -- 0x0bfa 0x0b
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "26" ] = {
    on_start = function( self )
        self.entity:init_npc( 9 ) -- 0x0d03 0x0b
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "27" ] = {
    on_start = function( self )
        self.entity:init_npc( 0 ) -- 0x0d9b 0x0b
        -- 0x19_SetPosition( x=(vf80)0x0129, z=(vf40)0x020a, flag=(flag)0x20 ) -- 0x0d9e 0x19
        -- MISSING OPCODE 0x20
    end,
...
Entity[ "31" ] = {
    on_start = function( self )
        self.entity:init_npc( 7 ) -- 0x10b5 0x0b
        -- MISSING OPCODE 0x5f
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x10bb 0x26
...
Entity[ "35" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit(); -- 0x12a0 0xbc
        -- MISSING OPCODE 0x18
    end,
...
Entity[ "36" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit(); -- 0x12ba 0xbc
        -- MISSING OPCODE 0x18
    end,
...
Entity[ "37" ] = {
    on_start = function( self )
        self.entity:init_npc( 6 ) -- 0x12ce 0x0b
        -- MISSING OPCODE 0x6a
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x12ea 0x26
...
Entity[ "40" ] = {
    on_start = function( self )
        self.entity:init_npc( 8 ) -- 0x14af 0x0b
        -- MISSING OPCODE 0x20
    end,
...
Entity[ "41" ] = {
    on_start = function( self )
        self.entity:init_npc( 6 ) -- 0x14d9 0x0b
        -- MISSING OPCODE 0x5f
    end,
...
Entity[ "42" ] = {
    on_start = function( self )
        self.entity:init_npc( 2 ) -- 0x154f 0x0b
        -- MISSING OPCODE 0x69
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x155c 0x26
...
Entity[ "43" ] = {
    on_start = function( self )
        self.entity:init_npc( 2 ) -- 0x1582 0x0b
        -- MISSING OPCODE 0x69
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x1589 0x26
...
Entity[ "44" ] = {
    on_start = function( self )
        self.entity:init_npc( 5 ) -- 0x159a 0x0b
        -- MISSING OPCODE 0x21
    end,
...
Entity[ "45" ] = {
    on_start = function( self )
        self.entity:init_npc( 0 ) -- 0x1722 0x0b
        -- MISSING OPCODE 0x1c
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x172b 0x26
...
Entity[ "46" ] = {
    on_start = function( self )
        self.entity:init_npc( 4 ) -- 0x173d 0x0b
        -- MISSING OPCODE 0x5f
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x1743 0x26
...
Entity[ "47" ] = {
    on_start = function( self )
        self.entity:init_npc( 1 ) -- 0x1751 0x0b
        -- MISSING OPCODE 0x5f
    end,

    on_update = function( self )
        -- 0x26_Wait( time=10 ); -- 0x1757 0x26
...
Entity[ "48" ] = {
    on_start = function( self )
        -- 0xBC_EntityNoModelInit(); -- 0x1763 0xbc
        -- 0x2A(); -- 0x1764 0x2a
