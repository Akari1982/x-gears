...
WalkmeshFile::WalkmeshFile( const Ogre::String& file ):
    File( file )
{
}
...
{
    Logger* export_script = new Logger( "wm.xml" );
    ...
    export_script->Log( "block_count " + Ogre::StringConverter::toString( block_count ) + "\n" );
