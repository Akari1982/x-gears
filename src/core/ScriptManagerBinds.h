...
ScriptManager::InitBinds()
{
    ...
    [
        luabind::class_< Entity >( "Entity" )
            ...
            .def( "set_interact_radius", ( void( Entity::* )( const float ) ) &Entity::SetInteractRadius )
            .def( "get_interact_radius", ( float( Entity::* )() ) &Entity::GetInteractRadius )
            .def( "set_interactable", ( void( Entity::* )( const bool ) ) &Entity::SetInteractable )
            .def( "is_interactable", ( bool( Entity::* )() ) &Entity::IsInteractable )
