...
EntityCollision::EntityCollision()
{
    ...
    *pPos++ = -1.0f; *pPos++ =  1.0f; *pPos++ =  0.0f;

    *pPos++ = -1.0f; *pPos++ =  0.0f; *pPos++ =  0.0f;
    *pPos++ = -0.9f; *pPos++ =  0.0f; *pPos++ =  0.5f;
    *pPos++ = -0.9f; *pPos++ =  0.0f; *pPos++ =  0.5f;
    *pPos++ = -0.9f; *pPos++ =  1.0f; *pPos++ =  0.5f;
    *pPos++ = -0.9f; *pPos++ =  1.0f; *pPos++ =  0.5f;
    *pPos++ = -1.0f; *pPos++ =  1.0f; *pPos++ =  0.0f;

    *pPos++ = -0.9f; *pPos++ =  0.0f; *pPos++ =  0.5f;
    *pPos++ = -0.5f; *pPos++ =  0.0f; *pPos++ =  0.9f;
    *pPos++ = -0.5f; *pPos++ =  0.0f; *pPos++ =  0.9f;
    *pPos++ = -0.5f; *pPos++ =  1.0f; *pPos++ =  0.9f;
    *pPos++ = -0.5f; *pPos++ =  1.0f; *pPos++ =  0.9f;
    *pPos++ = -0.9f; *pPos++ =  1.0f; *pPos++ =  0.5f;

    *pPos++ = -0.5f; *pPos++ =  0.0f; *pPos++ =  0.9f;
    *pPos++ =  0.0f; *pPos++ =  0.0f; *pPos++ =  1.0f;
    *pPos++ =  0.0f; *pPos++ =  0.0f; *pPos++ =  1.0f;
