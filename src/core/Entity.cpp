    ...
    m_AnimationAutoPlay( true )
{
    ...
    m_InteractCollision = new EntityCollision();
    m_InteractCollision->setMaterial( "entity/interact_collision" );
    m_InteractCollisionNode = m_SceneNode->createChildSceneNode();
    m_InteractCollisionNode->setScale( m_InteractRadius, m_InteractRadius, m_Height );
    m_InteractCollisionNode->attachObject( m_InteractCollision );
...
Entity::UpdateDebug()
{
    ...
    m_InteractCollisionNode->setVisible( debug > 0 && m_Interactable );
...
void
Entity::SetInteractRadius( const float radius )
{
...
float
Entity::GetInteractRadius() const
{
...
void
Entity::SetInteractable( const bool interactable )
{
