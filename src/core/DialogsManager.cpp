...
void
DialogsManager::Input( const Event& input )
{
    if( ( input.type == ET_PRESS ) && ( input.event == "message_ok" ) )
    {
        m_NextPressed = true;
    }
    else if ( ( input.type == ET_REPEAT ) && ( input.event == "message_ok" ) )
    {
        m_NextRepeated = true;
    }
    else if ( ( input.type == ET_PRESS ) && ( input.event == "message_up" ) )
    {
        m_UpPressed = true;
    }
    else if ( ( input.type == ET_PRESS ) && ( input.event == "message_down" ) )
    {
        m_DownPressed = true;
    }
}
